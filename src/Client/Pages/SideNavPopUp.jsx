...
export default ({ modalName }) => {
  ...
  const menuItems = [
    { category: "home", label: "Home", href: "/bd/en", icon: "icon-home.png" },
    { category: "promotion", label: "Promotions", href: "/bd/en/promotion", icon: "icon-promotion.png" },
    { category: "refer-bonus", label: "Refer Bonus", href: "/bd/en/member/common-referral", icon: "icon-refer-bonus.png" },
  ];
  ...
  return (
    <div className="cdk-global-overlay-wrapper" dir="ltr" >
      <div id="cdk-overlay-6" className="cdk-overlay-pane dialog-panel">
          ...
          <div className="popup__content">
            <div className="menu active">
              <div className="menu-first">
                ...
                <div className="title" style={{background:"#38094D"}}> <p style={{color:"#fff"}}>Games</p></div>
                <ul style={{background:"#38094D"}}>
