...
export default (props) => {
  ...
  //       {
  //         title: "PT",
  //         icon: "https://img.c88rx.com/cx/h5/assets/images/brand/black/provider-pt.png?v=1735560333041&source=mcdsrc",
  //         // url: "Spoerts",
  //       },
  //       {
  //         title: "DG",
  //         icon: "https://img.c88rx.com/cx/h5/assets/images/brand/black/provider-dg.png?v=1735560333041&source=mcdsrc",
  //         // url: "Spoerts",
  //       },
  //       {
  //         title: "MG",
  //         icon: "https://img.c88rx.com/cx/h5/assets/images/brand/black/provider-mg.png?v=1735560333041&source=mcdsrc",
  //         // url: "Spoerts",
  //       },
  //     ],
  //   },
  ...
  const { isAuthenticated, loginUser, logoutUser, verifyUser,userDeatils ,userId } =
    useAuth();
