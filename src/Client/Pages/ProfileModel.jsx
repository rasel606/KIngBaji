...
export default ({ modalName }) => {
  ...
  //    try {
  //      const response = await axios.post("https://kingbaji.live/api/v1/user_balance", {userId});
  //      setBalance(response.data.balance);
      ...
      <div onClick={(e) => e.stopPropagation()}>
        <div className="popup-page__main popup-page-main popup-page-main--show">
          <div className="member-menu active">
            ...
            >
              <div className="member-header-content bonuswallet">
                <div
                  className="pic"
                  style={{
                    backgroundImage:
            ...
            <div className="member-menu-content">
              ...
              <div className="member-menu-box member-list">
                ...
                <ul className="align-center">
                  ...
                  <li
                    className="deposit"
                    onClick={() => openModal("TurnOverModal")}
                  >
                    <Link>
                      <span
                      // className="item-icon"
                  ...
                  <li className="deposit">
                    <Link>
                      ...
                      >
                        <img
                          className="item-icon"
                          src="https://img.c88rx.com/cx/h5/assets/images/icon-set/theme-icon/member-center/icon-facebook-messenger.png?v=1738748531996"
                          alt=""
                        />
                      </span>
