            ...
            <Row className="custom-row">
              ...
              >
                ...
                >
                  <div className="text-center d-flex justify-content-center">
                    ...
                    <h6 className="mx-3 my-2 fs-2">Total - User</h6>
                  </div>
              ...
              >
                ...
                >
                  <div className="text-center d-flex justify-content-center">
                    <i class="a-duotone fa-solid fa-user fs-2 my-2"></i>
                    <h6 className="mx-2 my-2 fs-2">Total Online User</h6>
                  </div>
                  <h6 className="mx-2 my-2 fs-2 d-flex justify-content-center">
                    {500}
                  </h6>
              ...
              >
                ...
                >
                  <div className="text-center d-flex justify-content-center">
                    <i class="a-duotone fa-solid fa-user fs-2 my-2"></i>
                    <h6 className="mx-2 my-2 fs-2">Total Games</h6>
                  </div>
                  <h6 className="mx-2 my-2 fs-2 d-flex justify-content-center">
                    {500}
                  </h6>
              ...
              >
                ...
                >
                  <div className="text-center d-flex justify-content-center">
                    <i class="a-duotone fa-solid fa-user fs-2 my-2"></i>
                    <h6 className="mx-2 my-2 fs-2">Total Agents</h6>
                  </div>
                  <h6 className="mx-2 my-2 fs-2 d-flex justify-content-center">
                    {500}
                  </h6>
              ...
              >
                ...
                >
                  <div className="text-center d-flex justify-content-center">
                    <i class="a-duotone fa-solid fa-user fs-2 my-2"></i>
                    <h6 className="mx-2 my-2 fs-2">Total Balance</h6>
                  </div>
                  <h6 className="mx-2 my-2 fs-2 d-flex justify-content-center">
                    {500}
                  </h6>
              ...
              >
                ...
                >
                  <div className="text-center d-flex justify-content-center">
                    <i class="a-duotone fa-solid fa-user fs-2 my-2"></i>
                    <h6 className="mx-2 my-2 fs-2">Total Deposit</h6>
                  </div>
                  <h6 className="mx-2 my-2 fs-2 d-flex justify-content-center">
                    {500}
                  </h6>
